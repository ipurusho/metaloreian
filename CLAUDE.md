...
- **Backend:** Go 1.23 (chi router, goquery scraper, rod Chromium driver)
...
- Chromium is bundled in Docker image for rod scraper
- CORS: `FRONTEND_URL` env var must match domain exactly
- Memory limits in docker-compose.prod.yml tuned for VM resources
